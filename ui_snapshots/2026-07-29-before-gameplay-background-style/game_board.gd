...
func _create_game_decor() -> Control:
	...
	_add_mountain_silhouette(layer, size.y - 34.0, Color("c9b8ff"), 0.16)
	...
	_add_game_dot_cluster(layer, Vector2(size.x - 54, 72), 4, 5, 8.0, Color.WHITE, 0.18)
	_add_game_sparkle(layer, Vector2(34, 122), 14.0, UI_YELLOW, 0.34)
	return layer
