...
func _create_home_decor() -> Control:
	...
	_add_home_mountain_silhouette(layer, size.y - 22.0, Color("c9b8ff"), 0.20)
	...
	_add_home_dot_cluster(layer, Vector2(size.x - 58, 112), 4, 5, 8.0, UI_MAGENTA, 0.22)
	_add_home_sparkle(layer, Vector2(42, 178), 13.0, UI_YELLOW, 0.55)
	return layer
