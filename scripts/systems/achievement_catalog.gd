...
const DEFINITIONS: Array[Dictionary] = [
	...
	},
	{
		...
		"description_en": "Complete Endless Mode ascents.",
		"description_fi": "Suorita äärettömän pelin nousuja.",
		"accent": "purple"
	},
	{
		...
		"title_en": "Mountain Guide",
		"title_fi": "Vuoristo-opas",
		"description_en": "Reach summits in any game mode.",
		"description_fi": "Saavuta huippuja missä tahansa pelimuodossa.",
		"accent": "teal"
	},
	{
		"id": "burning_streak",
	...
	},
	{
		...
		"metric": "total_wins",
		"thresholds": [1],
		"title_en": "First Summit",
		"title_fi": "Ensimmäinen huippu",
		"description_en": "Complete your first Word Ascent.",
		"description_fi": "Suorita ensimmäinen sananoususi.",
		"accent": "yellow",
		"special": true
	},
	{
		...
		"description_en": "Win after restoring your final Stamina.",
		"description_fi": "Voita palautettuasi viimeisen kestävyyspisteesi.",
		"accent": "coral",
		"special": true
	},
	{
		...
		"description_en": "Win both Daily Challenge and Endless Mode.",
