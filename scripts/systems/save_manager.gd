...
const DEFAULT_SETTINGS: Dictionary = {
	...
	"analytics_consent_answered": false,
	"daily_notifications_enabled": false,
	"notification_consent_answered": false,
	"language": "en"
}
const SAVE_PATH: String = "user://word_pyramid_save.json"
const ENDLESS_DAILY_HEARTS: int = 3
const DAILY_UNLOCK_LEVEL: int = 3
const ONBOARDING_UNLIMITED_MIN_WIN_XP: int = 100
const XP_WIN_BASE: float = 45.0
const XP_DIFFICULTY_BONUS: float = 15.0
const XP_PERFORMANCE_BONUS: float = 40.0
const XP_PARTIAL_BASE: float = 8.0
const XP_PARTIAL_ROWS_BONUS: float = 18.0
const XP_REPEAT_MULTIPLIER: float = 0.65
...
const TEXT: Dictionary = {
	"en": {
		...
		"unlimited_button": "Endless Mode",
		"endless_subtitle": "Endless word ascents",
		"endless_play_button": "Play Endless →",
		...
		"daily_hearts_refilled": "Daily hearts refilled!",
		...
		"unlimited_mode_label": "Endless Mode",
		"home_subtitle": "Group words. Reach the summit.",
		"home_daily_title": "Around the Kitchen",
		"home_card_meta": "Food & Cooking · 15 words · 4 categories",
		"home_streak": "%d-day streak",
		"home_hint_markup": "Climb a [b][color=#1A0A5E]15-word[/color][/b] mountain — any order.\nYou get [b][color=#1A0A5E]2 hints[/color][/b] and [b][color=#1A0A5E]3 Stamina[/color][/b] for the ascent.",
		"pool_complete": "Congratulations! You have played all %s.",
		"statistics_title": "Statistics",
		"statistics_subtitle": "Your Word Ascent record",
		...
		"music": "Music",
		"daily_reminders": "Daily reminder · 10:00",
		"daily_reminders_note": "Reminds you when the new Daily Challenge is waiting.",
		"notification_consent_eyebrow": "DAILY REMINDER",
		"notification_consent_title": "Keep your climb going",
		"notification_consent_body": "Get one friendly reminder around 10:00 when the Daily Challenge is ready.",
		"notification_consent_accept": "Notify me",
		"notification_consent_decline": "Not now",
		"daily_notification_title": "Today's ascent is ready!",
		"daily_notification_body": "A new Daily Challenge is waiting for you.",
		"daily_notification_channel": "Daily Challenge reminders",
		"usage_analytics": "Share usage analytics",
		"usage_analytics_note": "Helps improve the game. No advertising ID is used.",
		"privacy_and_data": "Privacy & data",
		"analytics_status_on": "Analytics on",
		"analytics_status_off": "Analytics off",
		"analytics_consent_eyebrow": "OPTIONAL ANALYTICS",
		"analytics_consent_title": "Help make Word Ascent better",
		"analytics_consent_body": "Share pseudonymous usage data so we can improve puzzle difficulty, tutorials and game stability.",
		"analytics_consent_detail": "Firebase Analytics sends usage events to Google and Sepukka. We do not send your name, email, selected words or saved game progress. You can change this later in Settings.",
		"analytics_consent_accept": "Help improve the game",
		"analytics_consent_decline": "Not now",
		...
		"tutorial_title": "Practice Ascent",
		"tutorial_skip": "Skip",
		"tutorial_intro_eyebrow": "QUICK PRACTICE",
		"tutorial_intro_title": "Climb the Word Mountain",
		"tutorial_intro_body": "Find words connected by the same idea. Each correct group completes one level of the mountain.",
		"tutorial_intro_note": "Follow the steps, then complete the final group yourself.",
		"tutorial_intro_start": "Start practice",
		"tutorial_continue": "Continue",
		"tutorial_first_group": "Tap the two highlighted words that belong together.",
		"tutorial_select_group": "Tap the highlighted words that belong together.",
		"tutorial_press_check": "Great! Now press Check to place the group on the mountain.",
		"tutorial_mistakes_body": "A wrong group uses one Stamina. The ascent ends when all three are gone.",
		"tutorial_mistakes_title": "Protect your Stamina",
		"tutorial_mistakes_counter": "%d Stamina remaining",
		"tutorial_hint_title": "Use a hint",
		"tutorial_use_hint": "A hint locks one word into its correct mountain level. Press Hint.",
		"tutorial_finish_hint_row": "The hint started this level. Select the highlighted words that complete it.",
		"tutorial_top_any_order": "The one-word summit can be solved at any time. Select the highlighted word.",
		...
		"tutorial_find_last": "Select the final group and press Check.",
		"tutorial_open_order": "Two groups remain. Find either the 3-word or 4-word group first.",
		"tutorial_one_group_left": "Great! Only the %d-word group remains.",
		"tutorial_forced_hint": "Two Stamina lost. Use a Hint to reveal one word.",
		...
		"tutorial_restart_message": "No Stamina left. Let’s try the practice once more.",
		"daily_locked_title": "Daily Challenge",
		"daily_locked_body": "Reach Level %d in Endless Mode to unlock the daily puzzle.",
		"daily_locked_progress": "Level %d / %d",
		"daily_unlock_button": "Unlocks at Level %d",
		"daily_unlocked_reward": "DAILY CHALLENGE UNLOCKED",
		"tutorial_finish_row": "Complete this mountain level with the highlighted words, then press Check.",
		"tutorial_top_word": "Reach the summit: select the highlighted Summit Word and press Check.",
		"tutorial_complete": "You're ready!",
		"tutorial_complete_title": "Tutorial complete!",
		"tutorial_complete_subtitle": "You’re ready to continue with your first Endless puzzles.",
		"tutorial_continue_daily": "Continue to Endless Mode",
		"continue_to_unlimited": "Continue to Endless",
		...
		"share_result": "Share",
		"result_copied": "Ascent copied.",
		"view_solution": "View solution",
		"solution_title": "Final solution",
		"solution_subtitle": "Every mountain level and its connection",
		"solution_top_word": "Summit Word",
		"back_to_results": "Back to results",
		"share_mode_daily": "Daily Challenge",
		"share_mode_unlimited": "Endless",
		"share_summary": "Levels %d/5 · Stamina lost %d · Hints %d",
		"share_streak": "🔥 Streak %d",
		"aftermath_win_title": "Summit Reached!",
		"aftermath_loss_title": "Ascent Ended!",
		"aftermath_flawless": "Flawless ascent - full Stamina!",
		"aftermath_solved_mistakes": "Summit reached with %d Stamina lost",
		...
		"streak_calendar_title": "Daily calendar",
		"streak_current_week": "This week",
		"streak_previous_week": "Last week",
		"streak_correct": "Correct",
		"streak_wrong": "Wrong",
		"streak_empty": "Not played",
		"aftermath_endless_hearts": "Endless hearts left",
		"aftermath_group_found": "Found",
		"aftermath_group_missed": "Missed",
		"stat_mistakes": "Stamina lost",
		"stat_groups": "Groups",
		"stat_rows": "Levels",
		...
		"instructions_subtitle": "Complete all five mountain levels — in any order.",
		...
		"instructions_check_body": "Select the whole group, then press Check. Correct words lock into one mountain level.",
		"instructions_hint_title": "Use hints wisely",
		"instructions_hint_body": "Hint locks one word into its correct mountain level.",
		"instructions_hint_note": "HINT = one word is placed into its correct level for you",
		"instructions_mistake_title": "Protect your Stamina",
		"instructions_mistake_body": "A wrong group costs one Stamina.",
		"instructions_top_title": "Reach every level",
		"instructions_top_body": "Solve levels of 1, 2, 3, 4 and 5 words. You can complete them in any order.",
		"instructions_group_sizes": "LEVELS  1 · 2 · 3 · 4 · 5",
		...
		"instructions_correct_row": "Correct! The group locks into its mountain level.",
		"instructions_pool": "SHUFFLED WORDS",
		"instructions_completed_rows": "ALL 5 LEVELS",
		"instructions_choose_top": "ANY ORDER",
		"instructions_top_tile": "SUMMIT",
		...
		"hint_tooltip": "Hint: locked into the correct mountain level",
		"mistakes_left": "STAMINA  %d / %d",
		"selected": "Selected: %s",
		...
		"ad_hint": "Ad +1",
		"game_failed": "No Stamina left - showing the solution.",
		...
		"hint_placed": "Hint: %s was placed into the correct mountain level.",
		...
		"last_chance_eyebrow": "ONE MORE CHANCE",
		"last_chance_title": "One last push",
		"last_chance_body": "Your Stamina is empty. Watch a short ad to restore one Stamina and continue the ascent.",
		"last_chance_body_free": "Your Stamina is empty. Continue with one Stamina restored.",
		"last_chance_watch": "Watch ad & continue",
		"last_chance_continue": "Continue",
		"last_chance_give_up": "Show solution",
		"last_chance_loading": "Preparing ad...",
		"last_chance_cancelled": "Watch the ad to the end to restore one Stamina.",
		"last_chance_restored": "One Stamina restored!",
		"instructions_text": "Find groups of 2, 3, 4 and 5 words, then solve the Summit Word with one selection."
	},
	"fi": {
		"settings": "Asetukset",
		...
		"endless_subtitle": "Loputtomia sananousuja",
		...
		"daily_hearts_refilled": "Päivittäiset sydämet palautuivat!",
		...
		"home_subtitle": "Yhdistä sanat. Saavuta huippu.",
		"home_daily_title": "Keittiön äärellä",
		"home_card_meta": "Ruoka ja kokkaus · 15 sanaa · 4 kategoriaa",
		"home_streak": "%d päivän putki",
		"home_hint_markup": "Kiipeä [b][color=#1A0A5E]15 sanan[/color][/b] vuorelle — missä järjestyksessä tahansa.\nSaat [b][color=#1A0A5E]2 vihjettä[/color][/b] ja [b][color=#1A0A5E]3 kestävyyspistettä[/color][/b] nousua varten.",
		"pool_complete": "Onneksi olkoon! Olet pelannut kaikki %s.",
		"statistics_title": "Tilastot",
		"statistics_subtitle": "Word Ascent -tuloksesi",
		...
		"music": "Musiikki",
		"daily_reminders": "Daily-muistutus · klo 10",
		"daily_reminders_note": "Muistuttaa, kun uusi Daily Challenge odottaa.",
		"notification_consent_eyebrow": "PÄIVITTÄINEN MUISTUTUS",
		"notification_consent_title": "Pidä noususi käynnissä",
		"notification_consent_body": "Saat yhden ystävällisen muistutuksen noin klo 10, kun Daily Challenge on pelattavissa.",
		"notification_consent_accept": "Salli muistutus",
		"notification_consent_decline": "Ei nyt",
		"daily_notification_title": "Päivän nousu on valmis!",
		"daily_notification_body": "Uusi Daily Challenge odottaa sinua.",
		"daily_notification_channel": "Daily Challenge ‑muistutukset",
		"usage_analytics": "Jaa käyttöanalytiikkaa",
		"usage_analytics_note": "Auttaa parantamaan peliä. Mainostunnusta ei käytetä.",
		"privacy_and_data": "Tietosuoja ja data",
		"analytics_status_on": "Analytiikka käytössä",
		"analytics_status_off": "Analytiikka pois käytöstä",
		"analytics_consent_eyebrow": "VAPAAEHTOINEN ANALYTIIKKA",
		"analytics_consent_title": "Auta tekemään Word Ascentista parempi",
		"analytics_consent_body": "Jaa pseudonyymiä käyttötietoa, jotta voimme parantaa pulmien vaikeustasoa, opastusta ja pelin vakautta.",
		"analytics_consent_detail": "Firebase Analytics lähettää käyttötapahtumia Googlelle ja Sepukalle. Emme lähetä nimeäsi, sähköpostiosoitettasi, valitsemiasi sanoja tai tallennettua pelitilannettasi. Voit muuttaa valintaa myöhemmin asetuksissa.",
		"analytics_consent_accept": "Auta parantamaan peliä",
		"analytics_consent_decline": "Ei nyt",
		...
		"tutorial_title": "Harjoitusnousu",
		"tutorial_skip": "Ohita",
		"tutorial_intro_eyebrow": "NOPEA HARJOITUS",
		"tutorial_intro_title": "Kiipeä sanavuorelle",
		"tutorial_intro_body": "Etsi sanat, joita yhdistää sama asia. Jokainen oikea ryhmä täyttää yhden vuoren tason.",
		"tutorial_intro_note": "Seuraa vaiheita ja ratkaise lopuksi viimeinen ryhmä itse.",
		"tutorial_intro_start": "Aloita harjoitus",
		"tutorial_continue": "Jatka",
		"tutorial_first_group": "Napauta kahta korostettua sanaa, jotka kuuluvat yhteen.",
		"tutorial_select_group": "Napauta korostettuja sanoja, jotka kuuluvat yhteen.",
		"tutorial_press_check": "Hyvä! Sijoita ryhmä vuorelle painamalla Tarkista.",
		"tutorial_mistakes_body": "Väärä ryhmä kuluttaa yhden kestävyyspisteen. Nousu päättyy, kun kaikki kolme on käytetty.",
		"tutorial_mistakes_title": "Säästä kestävyyttäsi",
		"tutorial_mistakes_counter": "Kestävyyttä jäljellä: %d",
		"tutorial_hint_title": "Käytä vinkkiä",
		"tutorial_use_hint": "Vihje lukitsee yhden sanan oikealle vuoren tasolle. Paina Vihje.",
		"tutorial_finish_hint_row": "Vihje aloitti tämän tason. Valitse korostetut sanat, jotka täydentävät sen.",
		"tutorial_top_any_order": "Yhden sanan huipun voi ratkaista milloin tahansa. Valitse korostettu sana.",
		...
		"tutorial_find_last": "Valitse viimeinen ryhmä ja paina Tarkista.",
		"tutorial_open_order": "Kaksi ryhmää jäljellä. Voit ratkaista 3 tai 4 sanan ryhmän ensin.",
		"tutorial_one_group_left": "Hyvä! Jäljellä on enää %d sanan ryhmä.",
		"tutorial_forced_hint": "Kaksi kestävyyspistettä menetetty. Käytä vihjettä yhden sanan paljastamiseen.",
		...
		"tutorial_restart_message": "Kestävyys loppui. Kokeillaan harjoitusta uudelleen.",
		"daily_locked_title": "Päivän haaste",
		"daily_locked_body": "Saavuta äärettömässä pelissä taso %d avataksesi päivän haasteen.",
		"daily_locked_progress": "Taso %d / %d",
		"daily_unlock_button": "Avautuu tasolla %d",
		"daily_unlocked_reward": "PÄIVÄN HAASTE AVATTU",
		"tutorial_finish_row": "Täydennä vuoren taso korostetuilla sanoilla ja paina Tarkista.",
		"tutorial_top_word": "Saavuta huippu: valitse korostettu Huippusana ja paina Tarkista.",
		"tutorial_complete": "Olet valmis pelaamaan!",
		"tutorial_complete_title": "Opastus suoritettu!",
		"tutorial_complete_subtitle": "Olet valmis jatkamaan ensimmäisiin äärettömän pelin kenttiin.",
		"tutorial_continue_daily": "Jatka äärettömään peliin",
		...
		"share_result": "Jaa",
		"result_copied": "Nousu kopioitu.",
		"view_solution": "Katso ratkaisu",
		"solution_title": "Lopullinen ratkaisu",
		"solution_subtitle": "Kaikki vuoren tasot ja niiden yhteydet",
		"solution_top_word": "Huippusana",
		"back_to_results": "Takaisin tuloksiin",
		"share_mode_daily": "Päivän haaste",
		"share_mode_unlimited": "Ääretön",
		"share_summary": "Tasot %d/5 · Kestävyyttä menetetty %d · Vihjeet %d",
		"share_streak": "🔥 Putki %d",
		"aftermath_win_title": "Huippu saavutettu!",
		"aftermath_loss_title": "Nousu päättyi!",
		"aftermath_flawless": "Täydellinen nousu - kaikki kestävyys tallella!",
		"aftermath_solved_mistakes": "Huippu saavutettu, kestävyyttä menetetty %d",
		...
		"streak_calendar_title": "Daily-kalenteri",
		"streak_current_week": "Tämä viikko",
		"streak_previous_week": "Viime viikko",
		"streak_correct": "Oikein",
		"streak_wrong": "Väärin",
		"streak_empty": "Pelaamatta",
		"aftermath_endless_hearts": "Äärettömän pelin sydämet",
		"aftermath_group_found": "Löydetty",
		"aftermath_group_missed": "Puuttui",
		"stat_mistakes": "Kestävyyttä menetetty",
		"stat_groups": "Ryhmät",
		"stat_rows": "Tasot",
		...
		"instructions_subtitle": "Täytä kaikki viisi vuoren tasoa — missä järjestyksessä tahansa.",
		...
		"instructions_check_body": "Valitse koko ryhmä ja paina Tarkista. Oikeat sanat lukittuvat yhdelle vuoren tasolle.",
		"instructions_hint_title": "Käytä vihjeet harkiten",
		"instructions_hint_body": "Vihje lukitsee yhden sanan oikealle vuoren tasolle.",
		"instructions_hint_note": "VIHJE = yksi sana asetetaan puolestasi oikealle tasolle",
		"instructions_mistake_title": "Säästä kestävyyttäsi",
		"instructions_mistake_body": "Väärä ryhmä kuluttaa yhden kestävyyspisteen.",
		"instructions_top_title": "Saavuta kaikki tasot",
		"instructions_top_body": "Ratkaise 1, 2, 3, 4 ja 5 sanan tasot. Voit täyttää ne missä järjestyksessä tahansa.",
		"instructions_group_sizes": "TASOT  1 · 2 · 3 · 4 · 5",
		...
		"instructions_correct_row": "Oikein! Ryhmä lukittuu vuoren tasolle.",
		"instructions_pool": "SEKOITETUT SANAT",
		"instructions_completed_rows": "KAIKKI 5 TASOA",
		...
		"hint_tooltip": "Vihje: lukittu oikealle vuoren tasolle",
		"mistakes_left": "KESTÄVYYS  %d / %d",
		"selected": "Valitut: %s",
		...
		"ad_hint": "Mainos +1",
		"game_failed": "Kestävyys loppui - ratkaisu näytetään.",
		...
		"hint_placed": "Vihje: %s sijoitettiin oikealle vuoren tasolle.",
		...
		"last_chance_eyebrow": "VIELÄ YKSI MAHDOLLISUUS",
		"last_chance_title": "Vielä yksi ponnistus",
		"last_chance_body": "Kestävyytesi loppui. Katso lyhyt mainos, palauta yksi kestävyyspiste ja jatka nousua.",
		"last_chance_body_free": "Kestävyytesi loppui. Jatka yhdellä palautetulla kestävyyspisteellä.",
		"last_chance_watch": "Katso mainos ja jatka",
		"last_chance_continue": "Jatka",
		"last_chance_give_up": "Näytä ratkaisu",
		"last_chance_loading": "Valmistellaan mainosta...",
		"last_chance_cancelled": "Katso mainos loppuun, jotta yksi kestävyyspiste palautuu.",
		"last_chance_restored": "Yksi kestävyyspiste palautettu!",
		"instructions_text": "Etsi 2, 3, 4 ja 5 sanan ryhmät sekä ratkaise Huippusana yhdellä valinnalla."
	}
}
...
func record_result(won: bool, day_key: String = "", mode: String = "", correct_count: int = 0, total_count: int = 0, solved_groups: Array[int] = [], top_solved: bool = false, progression_reward: Dictionary = {}, mistakes_used: int = 0, hints_used: int = 0) -> void:
	...
	if notification_manager != null and notification_manager.has_method("refresh_schedule"):
		notification_manager.call_deferred("refresh_schedule")
...
func _calculate_progression_result(puzzle: Dictionary, mode: String, won: bool, solved_rows: int, mistakes_used: int, hints_used: int, persist: bool) -> Dictionary:
	...
	var mistake_ratio: float = clampf(float(mistakes_used) / float(MAX_ATTEMPTS), 0.0, 1.0)
	...
	var repeat_xp_multiplier: float = 1.0 if previous_attempts == 0 else XP_REPEAT_MULTIPLIER
	var raw_xp: float = 0.0
	if won:
		raw_xp = XP_WIN_BASE + XP_DIFFICULTY_BONUS * float(tier) + XP_PERFORMANCE_BONUS * performance
	elif solved_rows > 0:
		raw_xp = XP_PARTIAL_BASE + XP_PARTIAL_ROWS_BONUS * rows_ratio
	var xp_gained: int = maxi(roundi(raw_xp * repeat_xp_multiplier), 1) if raw_xp > 0.0 else 0
