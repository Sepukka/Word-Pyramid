...
const TEXT: Dictionary = {
	"en": {
		...
		"tutorial_intro_title": "Build a Word Pyramid",
		"tutorial_intro_body": "Find words connected by the same idea. Each correct group forms one row of the pyramid.",
		...
		"tutorial_mistakes_body": "A wrong group uses one attempt. Four mistakes end the puzzle.",
		"tutorial_mistakes_title": "Protect your attempts",
		"tutorial_mistakes_counter": "%d attempts available",
		...
		"share_result": "Share",
		"result_copied": "Pyramid copied.",
		"share_mode_daily": "Daily Challenge",
		"share_mode_unlimited": "Infinity",
		"share_summary": "Rows %d/5 · Mistakes %d · Hints %d",
	...
	"fi": {
		...
		"tutorial_intro_title": "Rakenna sanapyramidi",
		"tutorial_intro_body": "Etsi sanat, joita yhdistää sama asia. Jokainen oikea ryhmä muodostaa yhden pyramidin riveistä.",
		...
		"tutorial_mistakes_body": "Väärä ryhmä kuluttaa yhden yrityksen. Neljä virhettä päättää pelin.",
		"tutorial_mistakes_title": "Säästä yrityksiäsi",
		"tutorial_mistakes_counter": "%d yritystä käytettävissä",
		...
		"share_result": "Jaa",
		"result_copied": "Pyramidi kopioitu.",
		"share_mode_daily": "Päivän haaste",
		"share_mode_unlimited": "Infinite",
		"share_summary": "Rivit %d/5 · Virheet %d · Vihjeet %d",
