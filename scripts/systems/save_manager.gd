...
const TEXT: Dictionary = {
	"en": {
		...
		"instructions_variant_a": "B1  Example",
		"instructions_variant_b": "B2  Steps",
		"instructions_variant_c": "B3  Overview",
		"instructions_concept_a": "B1 · One complete worked example",
		"instructions_concept_b": "B2 · Three large step-by-step cards",
		"instructions_concept_c": "B3 · Steps and the whole pyramid together",
	...
	"fi": {
		...
		"instructions_variant_a": "B1  Esimerkki",
		"instructions_variant_b": "B2  Vaiheet",
		"instructions_variant_c": "B3  Yleiskuva",
		"instructions_concept_a": "B1 · Yksi kokonainen esimerkki",
		"instructions_concept_b": "B2 · Kolme suurta vaiheittaista korttia",
		"instructions_concept_c": "B3 · Vaiheet ja koko pyramidi yhdessä",
