...
const TEXT: Dictionary = {
	"en": {
		...
		"tutorial_intro_note": "We’ll help a lot at first — then you’ll finish on your own.",
		"tutorial_intro_start": "Start practice",
		"tutorial_continue": "Continue",
		"tutorial_first_group": "Start with plenty of help: tap the two highlighted words that belong together.",
	...
	"fi": {
		...
		"tutorial_intro_note": "Alussa autamme paljon — lopussa pääset ratkaisemaan itse.",
		"tutorial_intro_start": "Aloita harjoitus",
		"tutorial_continue": "Jatka",
		"tutorial_first_group": "Aloitetaan runsaalla avulla: napauta kahta korostettua sanaa, jotka kuuluvat yhteen.",
