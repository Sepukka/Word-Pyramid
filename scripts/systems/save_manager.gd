...
const TEXT: Dictionary = {
	"en": {
		...
		"instructions_subtitle": "Find related words. Lock every group. Reach the top.",
		...
		"instructions_top_body": "Complete groups of 2, 3, 4 and 5 words. Then choose the final top word.",
		...
		"instructions_completed_rows": "4 GROUPS COMPLETE",
		"instructions_choose_top": "CHOOSE THE TOP WORD",
	...
	"fi": {
		...
		"instructions_subtitle": "Etsi yhteydet. Lukitse ryhmät. Saavuta huippu.",
		...
		"instructions_top_body": "Täytä 2, 3, 4 ja 5 sanan ryhmät. Valitse lopuksi huippusana.",
		...
		"instructions_completed_rows": "4 RYHMÄÄ VALMIINA",
		"instructions_choose_top": "VALITSE HUIPPUSANA",
